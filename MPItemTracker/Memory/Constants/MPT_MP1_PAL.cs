...
{
    internal class MPT_MP1_PAL : _MP1
    {
        internal const long OFF_CGAMEGLOBALOBJECTS = 0x4E2BD0;
        internal const long OFF_CGAMESTATE = OFF_CGAMEGLOBALOBJECTS + 0x134;
        internal const long OFF_CSTATEMANAGER = 0x4C335C;
        internal const long OFF_MORPHBALLBOMBS_COUNT = 0x4C4E60;
