...
{
    internal class MP1_NTSC_0_00 : Prime
    {
        protected const long OFF_CPLAYERSTATE_GETITEMAMOUNT = 0x80091B1C;
        protected const long OFF_CPLAYERSTATE_POWERUPS_MAXCAPACITY = 0x803CD6C0;
        protected const long OFF_CGAMEGLOBALOBJECTS = 0x80457798;
        protected const long OFF_CGAMESTATE = OFF_CGAMEGLOBALOBJECTS + 0x134;
        protected const long OFF_CSTATEMANAGER = 0x8045A1A8;
        protected const long OFF_MORPHBALLBOMBS_COUNT = 0x80457D18;
