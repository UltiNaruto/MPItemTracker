...
{
    public class MP1_NTSC_J : Prime
    {
        protected const long OFF_CPLAYERSTATE_GETITEMAMOUNT = 0x80092D68;
        protected const long OFF_CPLAYERSTATE_POWERUPS_MAXCAPACITY = 0x803B9A50;
