...
{
    class MPT_MP3_NTSC_U : Corruption
    {
        protected const long OFF_CSTATEMANAGER = 0x805C6C68;
        protected const long OFF_CGAMEGLOBALOBJECTS = 0x805C98FC;
        ...
        protected override long CPlayerState
        {
            get
            {
                if (CPlayer == 0)
                    return 0;
                return GCMem.ReadUInt32(CPlayer + OFF_CPLAYERSTATE + 8);
            }
        }
