...
{
    public class MPT_MP2_NTSC_J : Echoes
    {
        protected const long OFF_CSTATEMANAGER = 0x804E7AD8;
        protected const long OFF_CGAMEGLOBALOBJECTS = 0x805CB9B8;
        ...
        protected override long CPlayerMorph
        {
            get
            {
                if (CPlayer == 0)
                    return 0;
                return GCMem.ReadUInt32(CPlayer + OFF_CPLAYER_CPLAYERMORPH - 0x28);
            }
        }
        ...
        protected override long CPlayerState
        {
            get
            {
                if (CPlayer == 0)
                    return 0;
                return GCMem.ReadUInt32(CPlayer + OFF_CPLAYERSTATE - 0x28);
            }
        }
        ...
        protected override bool HavePowerBeam
        {
            get
            {
                if (CPlayerState == 0)
                    return false;
                return GCMem.ReadUInt32(CPlayerState + OFF_POWERBEAM_OBTAINED - 4) > 0;
            }
        }
        ...
        protected override bool HaveDoubleDamage
        {
            get
            {
                if (CPlayerState == 0)
                    return false;
                return GCMem.ReadUInt32(CPlayerState + OFF_MP_DOUBLE_DAMAGE_OBTAINED - 4) > 0;
            }
        }
        ...
        protected override bool HaveUnlimitedMissiles
        {
            get
            {
                if (CPlayerState == 0)
                    return false;
                return GCMem.ReadUInt32(CPlayerState + OFF_MP_UNLIMITED_MISSILES_OBTAINED - 4) > 0;
            }
        }
        ...
        protected override bool HaveUnlimitedBeamAmmo
        {
            get
            {
                if (CPlayerState == 0)
                    return false;
                return GCMem.ReadUInt32(CPlayerState + OFF_MP_UNLIMITED_BEAM_AMMO_OBTAINED - 4) > 0;
            }
        }
